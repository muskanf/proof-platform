        ...
        <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
          ...
          <form className="space-y-4">
            <div>
              ...
              <input type="text" placeholder="Enter username" className="w-full p-2 border rounded"/>
            </div>
            <div>
            ...
            <div>
              ...
              <input type="password" placeholder="Create password" className="w-full p-2 border rounded"/>
            </div>
